...
export default new Catalog<Vocabulary>("ja", {
    ...
    "log/bot/keyvs/delete/faild": msg("Botのkeyvの削除に失敗しました。\nサーバー：{guild}\n詳細：\n{error}"),
    "log/bot/vcAutoCreation/createTriggerChannel": msg("VC自動作成機能のトリガーチャンネルを作成しました。\nサーバー：{guild}\nチャンネル：{channel}"),
    "log/bot/vcAutoCreation/deleteTriggerChannel": msg("VC自動作成機能のトリガーチャンネルを削除しました。\nサーバー：{guild}\nチャンネル：{channel}"),
    "log/bot/vcAutoCreation/deleteAutoCreatedChannel": msg("VC自動作成: 自動作成チャンネルを手動削除により除外 [Guild: {guild}, Channel: {channel}]"),
    "log/bot/vcAutoCreation/error": msg("VC自動作成機能でエラーが発生しました。\nサーバー：{guild}\n詳細：\n{error}"),
    "log/bot/vcAutoCreation/createChannel": msg("VC自動作成: チャンネル作成 [Guild: {guild}, Channel: {channel}]"),
    "log/bot/vcAutoCreation/deleteChannel": msg("VC自動作成: チャンネル削除 [Guild: {guild}, Channel: {channel}]"),
    "log/bot/vcAutoCreation/channelAlreadyDeleted": msg("VC自動作成: チャンネルは既に削除されています [Guild: {guild}, Channel: {channel}]"),
    "log/bot/vcAutoCreation/deleteChannelFailed": msg("VC自動作成: チャンネル削除失敗 [Guild: {guild}, Channel: {channel}, Error: {error}]"),
    ...
    "log/bot/bumpReminder/error": msg("Bumpのリマインド機能でエラーが発生しました。\nサーバー：{guild}\nチャンネル：{channel}\n詳細：\n{error}"),
    ...
    "log/bot/sendMemberLeaveLog": msg("メンバー脱退ログを送信しました。\nサーバー：{guild}\nチャンネル:{channel}\nユーザー：{user}"),

    // Bot
    "bot/config/reset": msg("Botの設定をリセットしました。"),
    "bot/vcAutoCreation/error": msg("VC自動作成機能でエラーが発生しました。\n詳細：\n{error}"),
    ...
    "bot/command/cnf-vac/start/faild": msg("VC自動作成機能の開始に失敗しました。\n詳細：\n{error}"),
    ...
    "bot/command/cnf-vac/start/alreadyStarting": msg("このカテゴリーではVC自動作成機能は既に開始しています。"),
    "bot/command/cnf-vac/stop/description": msg("VC自動作成機能を停止します。"),
    "bot/command/cnf-vac/stop/success": msg("VC自動作成機能を停止しました。"),
    "bot/command/cnf-vac/stop/faild": msg("VC自動作成機能の停止に失敗しました。\n詳細：\n{error}"),
    ...
    "bot/command/cnf-vac/stop/notStarted": msg("このカテゴリーではVC自動作成機能は開始されていません。"),
    "bot/command/cnf-vac/status/description": msg("VC自動作成機能の状態を表示します。"),
    "bot/command/cnf-vc/description": msg("VCの設定をします。"),
    "bot/command/cnf-vc/notInVc": msg("設定するVCに入室中に実行してください。"),
    "bot/command/cnf-vc/notVacChannel": msg("VC自動作成機能で作成されたVC以外は設定を変更できません。"),
    ...
    "bot/command/cnf-vc/lock/description": msg("コマンドでVCの設定を変更できないようにします。"),
    "bot/command/cnf-vc/lock/channelOption/description": msg("ロックするVCを指定してください。"),
