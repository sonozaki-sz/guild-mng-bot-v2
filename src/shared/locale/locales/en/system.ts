...
export const system = {
  ...
  "shutdown.cleanup_complete": "[Bot] Cleanup completed",
  "shutdown.cleanup_failed": "[Bot] Error during cleanup:",
  ...
  "database.prisma_not_available": "[Database] Prisma client is not available",
