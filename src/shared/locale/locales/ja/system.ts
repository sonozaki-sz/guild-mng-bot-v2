...
export const system = {
  ...
  "error.cleanup_complete": "Bot: クリーンアップ完了。",
  "error.cleanup_failed": "Bot: クリーンアップ中のエラー:",

  // ロケール
  "locale.manager_initialized": "Bot: LocaleManagerをi18nextで初期化しました。",
  ...
  "scheduler.bump_reminder_restore_failed": "Bumpリマインダー機能: 復元に失敗:",
  ...
  // Bot起動イベントログ
  // 起動完了時のサマリーログ
  "ready.bot_ready": "Bot: ✅ Botの準備が完了しました！ {{tag}} としてログイン",
